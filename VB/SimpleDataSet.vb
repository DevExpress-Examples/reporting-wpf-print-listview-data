...
Namespace WPFPrintListView
	Public Class SimpleDataSet
		...
		Public Shared Function CreateData() As SimpleDataSet
			...
			For i As Integer = 0 To 99
				table.Rows.Add(New Object() { i, DateTime.Today.AddDays(1), (If(i Mod 2 = 0, "A", "B")), Math.Round(rnd.NextDouble() * 100, 2) })
			Next i
	...
	<ValueConversion(GetType(DateTime), GetType(String))>
	Public Class DateConverter
		...
		Public Function ConvertBack(ByVal value As Object, ByVal targetType As Type, ByVal parameter As Object, ByVal culture As System.Globalization.CultureInfo) As Object Implements IValueConverter.ConvertBack
			...
			Dim resultDateTime As DateTime = Nothing
